...
from rag.eval.provenance import Provenance, collect_provenance, corpus_commit
...
def test_corpus_commit_outside_a_repository_is_unknown(tmp_path: Path) -> None:
    assert corpus_commit(tmp_path) == "unknown"
